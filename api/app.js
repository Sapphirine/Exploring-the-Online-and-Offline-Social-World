...
swagger.addModels(models)
  .addGet(routes.analytics.getTopMemberGroupByTag)
  .addGet(routes.analytics.getTopEventGroupByTag)
  .addGet(routes.analytics.getNetworkByTag)
  .addGet(routes.analytics.getEventLocationByTag)
